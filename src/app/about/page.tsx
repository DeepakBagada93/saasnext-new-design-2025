            ...
            <section className="pt-32 md:pt-48 pb-20 md:pb-28">
                <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative h-96 w-full">
                        {aboutHeroImage && (
                            <Image src={aboutHeroImage.imageUrl} alt="SaaSNext Team - Best Web Developers in Junagadh" data-ai-hint={aboutHeroImage.imageHint} fill className="object-cover rounded-lg shadow-lg" />
                        )}
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-28 bg-card">
                <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <TextReveal>
                            <p className="mt-4 text-muted-foreground text-lg">We follow a transparent, four-step process to ensure project success and keep you involved at every stage of your web development or marketing journey.</p>
                        </TextReveal>
                    </div>
