...
export const pricingPlans = [
  ...
  },
  {
    ...
    plans: [
      {
        title: "3-Day Launch Website",
        price: "₹5,000 – ₹15,000",
        priceUsd: "$60 - $180",
        description: "Affordable rapid-launch package for Indian startups & local businesses",
        features: [
      ...
      },
      {
        ...
        price: "₹19,999 – ₹49,999",
        priceUsd: "$250 - $600",
        description: "Launch your business online with a modern, professional website.",
        features: [
          "1–5 premium pages",
      ...
      },
      {
        ...
        price: "₹69,999 – ₹1,29,999",
        priceUsd: "$850 - $1,600",
        description: "Designed to generate leads, bookings, and conversions.",
        features: [
      ...
      {
        title: "Pro Digital Platform",
        price: "₹1,50,000 – ₹3,00,000+",
        priceUsd: "$1,800 - $3,600+",
        description: "A complete high-performance business platform built for scale.",
        features: [
